...
### Assignement 1
Burningcode/RepData_PeerAssessment1
...
```{r timeSeriesPlotMissingsEstimated, fig.height=6, fig.width=10}
...
```{r timeSeriesPlotMissingsEstimatedWeekDayWeekEnd, fig.height=6, fig.width=10}
...
```{r SuperposeDays, fig.height=6, fig.width=10}     
